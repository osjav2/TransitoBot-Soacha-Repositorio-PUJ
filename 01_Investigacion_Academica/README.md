...
## 🛠️ 1. Fundamentación Técnica (IA & LLMs)
*Documentos alojados en `/Conceptualizacion_tecnica`*

Base teórica sobre la tecnología seleccionada para la arquitectura híbrida.

| Documento | Descripción Técnica |
| :--- | :--- |
| **[Paper Base: LLMs](./Conceptualizacion_tecnica/LLM%20paper.pdf)** | Estado del arte sobre Modelos de Lenguaje Grandes. |
| **[Arquitectura Transformers](./Conceptualizacion_tecnica/tranformers.pdf)** | Fundamentos de la arquitectura neuronal utilizada. |
| **[Gestión de Tokens](./Conceptualizacion_tecnica/tokens.pdf)** | Análisis de costos y ventanas de contexto. |
| **[Librerías del Proyecto](./Conceptualizacion_tecnica/librerias_ha_usar.pdf)** | Selección del Stack Tecnológico (Python). |
| **[Estudio UX Chatbots](./Conceptualizacion_tecnica/SatisfacccionenelUsodeChatbot.pdf)** | Investigación sobre satisfacción de usuario en bots. |

---

## 📋 2. Gestión del Proyecto (Ingeniería de Software)
*Documentos alojados en `/Gestión_TG` y Raíz*

Artefactos de planificación temporal y definición de alcance funcional (Metodología Ágil).
...
## 🏛️ 3. Marco Estratégico y Legal
*Documentos alojados en `/Soportes_Contexto`*
...
Recopilación de noticias, estadísticas y sentimiento social que validan la urgencia de la solución.
...
### 📌 Nota de Navegación
Para visualizar los documentos, haga clic en el título en **negrilla**. Los nombres de archivo se conservan originales para trazabilidad.
